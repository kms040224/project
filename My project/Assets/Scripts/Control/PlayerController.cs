...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //바라볼 위치를 계산ㅇ하기 위해서 오브젝트 y축 좌표를 설정(바닥은 x,z 축)
        ...
        //w,a,s,d 나 화살표ㅗ 이동 or 지원하는 이동입력 도구 (Horizontal , Vertical)
    ...
    private void FixedUpdate()
    {
        ...
        //GetComponent ->소스가 있는 게임 오브젝트에서 <> 안에 있는 컴포넌트를 접근
        //접근을 한 후에 계산 된 이동 위치 값은 MovePosition 함수에 적용
    }
}
